...
module.exports = {
  ...
  // NOTE: to ensure consistency with automated deployments, the following two items in each deployment should match environment names in GitHub:
  // 1. The name of the deployment itself (the root keys in this object)
  // 2. The postfix of the SSH key path (e.g. ~/.ssh/menklab/dracarys-backend-dev, ~/.ssh/menklab/dracarys-backend-prod)
  ...
  deploy: {
    ...
    dev: {
      ...
      // For CI/CD - add the private key to the project secrets and use the path below.
      key: '~/.ssh/menklab/dracarys-backend-dev',
